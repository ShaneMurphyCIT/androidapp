...
public class SamsungFingerPrintActivity extends Activity implements Handler.Callback {
    ...
    private SpassFingerprint.IdentifyListener mIdentifyListener = new SpassFingerprint.IdentifyListener() {
        ...
        public void onFinished(int eventStatus) {
            ...
            if (eventStatus == SpassFingerprint.STATUS_AUTHENTIFICATION_SUCCESS) {
                ...
                Intent intent = new Intent(SamsungFingerPrintActivity.this,UniqueTokenActivity.class);
        ...
        if (onReadyIdentify == false) {
            ...
            try {
                if (mSpassFingerprint != null) {
                    ...
                    mSpassFingerprint.startIdentifyWithDialog(SamsungFingerPrintActivity.this, mIdentifyListenerDialog, backup);
                }
    ...
    private void registerFingerprint() {
        if (onReadyIdentify == false) {
            if (onReadyEnroll == false) {
                onReadyEnroll = true;
                if (mSpassFingerprint != null) {
                    mSpassFingerprint.registerFinger(SamsungFingerPrintActivity.this, mRegisterListener);
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_samsungfingerprint);
        ...
        try {
            mSpass.initialize(SamsungFingerPrintActivity.this);
        } catch (SsdkUnsupportedException e) {
            log("Exception: " + e);
        } catch (UnsupportedOperationException e) {
            log("Fingerprint Service is not supported in the device");
        }
        isFeatureEnabled_fingerprint = mSpass.isFeatureEnabled(Spass.DEVICE_FINGERPRINT_AVAILABLE_PASSWORD);

        if (isFeatureEnabled_fingerprint) {
            mSpassFingerprint = new SpassFingerprint(SamsungFingerPrintActivity.this);
